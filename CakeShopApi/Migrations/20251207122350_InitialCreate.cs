    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Barcode", "Name", "Price", "PricePerKg", "StockQty", "Type" },
                values: new object[,]
                {
                    { 1, "111", "Chocolate Cake", 1500m, 0m, 10m, "fixed" },
                    { 2, "222", "Ribbon Cake", 0m, 2500m, 20m, "weight" },
                    { 3, "333", "Cup Cake", 300m, 0m, 25m, "fixed" }
                });
        }
